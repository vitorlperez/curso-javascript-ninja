    ...
    if(isOperatorValid(operador) === false){
        ...
        return function(par1,par2){
            if(typeof par1 !== 'number' || typeof par2 !== 'number'){
                ...
                return operation[operador](par1,par2);
            }
        }
    }
}
...
function showErrorMessage(operador){
    return 'Operação "' + operador + '" não permitada!';
}
...
console.log(showOperationMessage('-', number1,number2),subtraction(number1,number2));

var multiplication = calculator('*');
console.log(showOperationMessage('*', number1,number2),multiplication(number1,number2));

var division = calculator('/');
console.log(showOperationMessage('/', number1,number2),division(number1,number2));

var mod = calculator('%');
console.log(showOperationMessage('%', number1,number2),mod(number1,number2));
