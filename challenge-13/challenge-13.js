...
*/
var nordeste = ['AL', 'BH', 'MA', 'CE', 'PB', 'PE', 'PI', 'RN', 'SE'];
...
if(every){
    ...
    console.log('Não nem todos os estados tem mais de 7 letras!')
}
...
if(some){
    ...
    console.log('Ceará não está incluido :(');
}
